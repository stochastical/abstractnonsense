...
aliases:
  - /micro-blog/2025-05-29-apache-spark-4.0-released/
---
...
- A new [`DESCRIBE TABLE AS JSON`](https://issues.apache.org/jira/browse/SPARK-50541) option. I really dislike unstructured command line outputs that you have to parse with `awk`ward bashisms. JSON input/outputs and manipulation with [`jq`](/microblog/2025-02-18-surely-youre-jqing/) is a far more expressive consumption pattern that I feel captures the spirit of command line processing.
